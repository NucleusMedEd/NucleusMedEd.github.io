...
dupuytrenContracture.overView = "Dupuytren’s contracture is also a common cause of locking of the digits, especially in diabetic patients. Dupuytren's disease is caused by a thickening of the palmar fascia and most commonly affects the fourth and fifth digits. Although the underlying etiology for the development of Dupuytren disease is uncertain, the basic pathophysiology involves fibroblast proliferation, and collagen deposition leading to contractures of the palmar fascia. Investigators have proposed several hypotheses for the pathogenesis of Dupuytren disease. Some theories about the etiology of the disease is that an individual with a genetic predisposition to develop Dupuytren disease experiences a second inciting event (ie, smoking, diabetes, trauma, alcoholism), resulting in microvascular ischemia. The localized ischemia causes two events to take place in the palmar fascia: (1) the conversion of adenosine triphosphate to hypoxanthine and (2) the conversion of xanthine dehydrogenase to xanthine oxidase. Xanthine oxidase acts as a catalyst for the oxidation of hypoxanthine to xanthine and uric acid; this conversion results in the production of free radicals. Free radicals result in fibroblast proliferation and the production of numerous cytokines. Interleukin 1 (IL-1) is the most abundant cytokine in Dupuytren disease and, via its receptor, upregulates the production of transforming growth factor beta (TGF-beta), fibroblast growth factor, epidermal-derived growth factor, and platelet-derived growth factor. This milieu of cytokines and growth factors results in the proliferation of fibroblasts and their differentiation into myofibroblasts (the primary cell type in Dupuytren disease). Excess type III collagen production occurs from an increased density of fibroblasts secondary to enhanced stimulation and diminished apoptosis, as well as an imbalance between the collagenases and their endogenous inhibitors. Dupuytren fascia exhibits an increased ratio of tissue inhibitors of metalloproteinases (TIMP) to matrix metalloproteinases (MMP).";

triggerFinger.overView = "Trigger finger is a type of stenosing tenosynovitis. It commonly affects patients over the age of 45 and is more common in diabetics. It presents with a nodule usually located at the MCP joint of either the index or ring fingers. Patients complain of the finger “catching” and becoming locked in a flexed position. It is treated with conservative treatments such as stretching, splinting and ice followed by corticosteroid injections and finally surgery. A mismatch between the flexor tendon and the proximal pulley mechanism occurs in most cases of TF. Normally, the tendons of the finger flexors glide back and forth under a restraining pulley. Thickening of the flexor tendon sheath restricts the normal gliding mechanism. A nodule may develop on the tendon, causing the tendon to get stuck at the proximal edge of the A1 pulley when the patient is attempting to extend the digit, thereby causing difficulty. When more forceful attempts are made to extend the digit, by using increased force from the finger extensors or by applying an external force (for example, by exerting force on the finger with the other hand), the digit classically snaps open with significant pain at the distal palm and into the proximal aspect of the affected digit. Less commonly, the nodule is restricted distal to the A1 pulley, resulting in difficulty flexing the digit.";

ganglionCyst.overView = "A ganglion cyst is an out pocketing of synovial tissue. It can occur anywhere in the wrist and hand but is most common on the dorsal aspect of the wrist. It presents as a painless mass. Although ganglion cysts can be unilobulated, they are most often multilobulated, with septa made from connective tissue separating the lobes or cavities. Because there is no epithelial lining of the cyst wall, a ganglion cyst is not a true cyst and, because of this histologic observation, the theories of synovial herniation or synovial tumor formation are not supported and may be disputed. Hyaluronic acid predominates the mucopolysaccharides that make up the fluid within the cyst’s cavity, whereas collagen fibers and fibrocytes make up the wall lining. The development of these cysts is histologically observable beginning with swollen collagen fibers and fibrocytes, followed by a degeneration and liquefaction of these elements, a termination of degeneration, and, lastly, a proliferation of the connective tissue, resulting in a border that is dense in texture.";
